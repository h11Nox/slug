...
use common\components\transliterate\TransliteratorHelper;
...
class SluggableBehavior extends \yii\behaviors\SluggableBehavior
{
    ...
    protected function getValue($event)
    {
        ...
        if ($this->attribute !== null) {
            ...
            if ($isNewSlug) {
                ...
                $slug = $this->transliterate($slugParts);
            } else {
     ...
     * @return string
     */
    protected function transliterate($parts){
        return Inflector::slug(TransliteratorHelper::process(implode(' ', $parts)), '-', true );
    }
}